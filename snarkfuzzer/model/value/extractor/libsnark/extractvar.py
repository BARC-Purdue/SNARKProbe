...
class Extractor(object):
    ...
    def setup(self):
        ...
        self.part = str(gdb.parse_and_eval("$part")).strip("\"")
    ...
    def readScheme(self):
        schemepath = str(gdb.parse_and_eval("$schemepath")).strip("\"")
        print(schemepath)
        input(">>>>>")
        ...
        for info in content:
            ...
            # check if variable require continue
